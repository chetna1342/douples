...
import faiss
from pcking_faiss_index import load_faiss_index
...
lstm_model = load_model('LSTM_Model_automob_douples.keras')
label_encoder = pickle.load(open('label_encoder_automob_douples.pkl', 'rb'))
